                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('title3', '', ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <br>
                                    @if ($errors->has('title1'))
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('title4', '', ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <br>
                                    @if ($errors->has('title1'))
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('title5', '', ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <br>
                                    @if ($errors->has('title1'))
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('title6', '', ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <br>
                                    @if ($errors->has('title1'))
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('title7', '', ['class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    <br>
                                    @if ($errors->has('title1'))
